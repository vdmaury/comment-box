...
{
    // default connection
    public static $dbname = 'amh_db'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = 'saga123'; // // Your database password
    ...
    // editor
    public static $editor_url = true;//'editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
